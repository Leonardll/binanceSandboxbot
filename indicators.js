const CCKey = "a9b8d7696b192ed7a0d60bf2714e4a96143c405877feb1886cffca3263fe4d7a";
const CryptoCompareAPI = require("cryptocompare");
CryptoCompareAPI.setApiKey(CCKey);


module.exports = {
    movingAverage: function movingAverage(cryptoAsset,fiatCurrensy,hours,callback) {
        if(hours>169) {
    ...
    movingAverageDay: function movingAverageDay(cryptoAsset,fiatCurrensy,days,callback) {
      if(days>365) {
    ...
    movingAverageMinute: function movingAverageMinute(cryptoAsset,fiatCurrensy,minute,callback) {
      if(minute>1440) {
